...
public class BookSubmission {
    ...
    public BookSubmission(String title, String authorUsername, String authorFullName,
        ...
        this(title, authorUsername, authorFullName, genre, description, filePath, "");
    }

    public BookSubmission(String title, String authorUsername, String authorFullName,
                         String genre, String description, String filePath, String coverImagePath) {
    ...
    public BookSubmission(String submissionId, String title, String authorUsername,
        ...
        this(submissionId, title, authorUsername, authorFullName, genre, description, filePath, "", submissionDate, status, rejectionReason, reviewedDate, reviewedBy);
    }

    public BookSubmission(String submissionId, String title, String authorUsername,
                         String authorFullName, String genre, String description,
                         String filePath, String coverImagePath, LocalDateTime submissionDate, String status,
                         String rejectionReason, LocalDateTime reviewedDate, String reviewedBy) {
    ...
    public static BookSubmission fromString(String data) {
        ...
        if (parts.length >= 12) {
            ...
            if (parts.length >= 13) {
                ...
                LocalDateTime reviewedDate = parts[11].isEmpty() ? null :
                        LocalDateTime.parse(parts[11], formatter);
                return new BookSubmission(
                        parts[0], parts[1], parts[2], parts[3], parts[4],
                        parts[5], parts[6], parts[7], submissionDate, parts[9],
                        parts[10].isEmpty() ? null : parts[10],
                        reviewedDate, parts[12].isEmpty() ? null : parts[12]
                );
            }
